"""
Quaternion layer implemented via the kingdon geometric algebra library.
Uses Algebra(0,2) = Cl(0,2) to derive the Hamilton multiplication table,
then applies it identically to PHMLinear with frozen a-tensor.
"""
import math
import torch
